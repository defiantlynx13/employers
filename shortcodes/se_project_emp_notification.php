...
add_shortcode('SE_project_emp_notification' , 'SE_project_emp_notification_function');


function SE_project_emp_notification_function()
{
    ...
    {
        require_once( plugin_dir_path(__FILE__) . 'shortcodes-content/employers/se_project_emp_notification_content.php' );
    }
