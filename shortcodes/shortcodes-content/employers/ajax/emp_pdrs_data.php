...
add_action("wp_ajax_employee_pdaily_reports_data","employee_pdaily_reports_data_server_side_callback");
function employee_pdaily_reports_data_server_side_callback()
{
    ...
    $query = "SELECT * FROM {$table} WHERE pid={$pid} and status='published'";
...
//        $sub_array[] = '<td class="text-xs-center" >'.$count.'</td>';
        ...
        $sub_array[] = '<button type="button" id="se_pdr_complete" name="se_pdr_complete" class="btn btn-sm btn-primary btn-rounded  mr-1 mb-1" data-id="'.$result->id.'"><i class="icon-eye6 fa-lg"></i></button>';
