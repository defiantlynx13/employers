                                ...
                                global $wpdb;
                                    ...
                                    if (isset($_GET['p_id'],$_GET['target_tbl'],$_GET['pss_id']))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                require_once( ABSPATH . 'wp-content/plugins/emp/shortcodes/shortcodes-content/employers/print/tables/se_emp_print_pss_con.php' );
                                            }
                                            else
                                            {
                                                wp_redirect(home_url('se_panel'));
                                    ...
                                    elseif (isset($_GET['p_id'],$_GET['target_tbl']))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                require_once( ABSPATH . 'wp-content/plugins/emp/shortcodes/shortcodes-content/employers/print/tables/se_emp_print_pfb.php' );
                                            }
                                            else
                                            {
                                                wp_redirect(home_url('se_panel'));
