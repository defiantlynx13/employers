                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <label class="display-inline-block custom-control custom-radio ml-1">
                                                            <input type="radio" name="pnn_receiver" checked="" class="custom-control-input" value="employee">
                                                            <span class="custom-control-indicator"></span>
                                                            <span class="custom-control-description ml-0">کارفرما</span>
                                                        </label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function ()
        {
                ...
                (
                    {
                        ...
                        "serverSide": true,
                        "ajax": {
                            "url"  : "<?php echo admin_url('admin-ajax.php?action=project_message_sent_data&p_id=' . $p_id)?>"
                        },
                ...
                (
                    {
                        ...
                        "serverSide": true,
                        "ajax": {
                            "url"  : "<?php echo admin_url('admin-ajax.php?action=project_message_recevie_data&p_id=' . $p_id)?>"
                        },
                        "fnDrawCallback" : function() {
                            traverse(document.body);
            ...
            $(document).on('click', '#se_pn_delete', function(){
                ...
                {
                    $.ajax({
                        url:"<?php echo admin_url('admin-ajax.php?action=pmd')?>",
                        data:{
                            id:id,
                        },
            ...
            $(document).on('click', '#se_pmr_delete', function(){
                ...
                {
                    $.ajax({
                        url:"<?php echo admin_url('admin-ajax.php?action=pmrd')?>",
                        data:{
                            id:id,
                        },
                        success:function(data){
            ...
            $(document).on('click', '#se_project_send_message_title', function(){
                ...
                if (status == "pending")
                {
                    setTimeout(
                        ...
                        {
                            $.ajax({
                                url: "<?php echo admin_url('admin-ajax.php?action=project_admin_send_message_update_status')?>",
                                data: {
                                    id: id,
                                },
                                success: function (data)
