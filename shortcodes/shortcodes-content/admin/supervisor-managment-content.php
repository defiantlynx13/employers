                ...
                <div class="col-xs-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <table id="supervisors_tbl" class="table table-responsive-sm table-sm table-hover table-bordered mb-0">

                                <thead class="thead-inverse">
                                <tr>
                                    <th class="text-xs-center align-middle"  width="10%">#</th>
                                    <th class="text-xs-center align-middle">نام و نام خانوداگی</th>
                                    <th class="text-xs-center align-middle">نام کاربری</th>
                                    <th class="text-xs-center align-middle">رمز عبور</th>
                                    <th class="text-xs-center align-middle" >ایمیل</th>
...
<div class="modal fade text-xs-left" id="edit_supervisor_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <label class="modal-title text-text-bold-600" id="myModalLabel33">ویرایش سرپرست</label>
            </div>
                ...
                <form class="form" method="post" action="">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_edit_fname">نام</label>
                                    <input type="text" id="sup_edit_fname" class="form-control border-primary" placeholder="نام"  name="sup_edit_fname"  required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_edit_lname">نام خانوادگی</label>
                                    <input type="text" id="sup_edit_lname" class="form-control border-primary" placeholder="نام خانوادگی" name="sup_edit_lname"  required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_edit_user_name">نام کاربری</label>
                                    <input type="text" id="sup_edit_user_name" class="form-control border-primary" placeholder="نام کاربری" name="sup_edit_user_name"  required readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_edit_pass">گذرواژه</label>
                                    <input type="password" id="sup_edit_pass" class="form-control border-primary" placeholder="گذرواژه" name="sup_edit_pass" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_edit_email">ایمیل</label>
                                    <input type="email" id="sup_edit_email" class="form-control border-primary" placeholder="ایمیل" name="sup_edit_email"  required>
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_edit_status">وضعیت</label>
                                    <div class="input-group">
                                        <label class="display-inline-block custom-control custom-radio ml-1">
                                            <input type="radio" id="sup_edit_status_enable" name="sup_edit_status" class="custom-control-input" value="enable">
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description ml-0">فعال</span>
                                        </label>
                                        <label class="display-inline-block custom-control custom-radio">
                                            <input  type="radio" id="sup_edit_status_disable" name="sup_edit_status" class="custom-control-input" value="disable">
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description ml-0">غیر فعال</span>
                                        </label>
                    ...
                    <div class="form-actions right">
                        ...
                        <button type="button" class="btn btn-primary" name="sup_edit_submit" id="sup_edit_submit">
                            <i class="icon-check2"></i> ویرایش
                        </button>
                        <input type="hidden" id="sup_edit_id" name="sup_edit_id">
                    </div>
                </form>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <label class="modal-title text-text-bold-600" id="myModalLabel33">افزودن سرپرست</label>
            </div>
                ...
                <form class="form" method="post" action="">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_add_fname">نام</label>
                                    <input type="text" id="sup_add_fname" class="form-control border-primary" placeholder="نام"  name="sup_add_fname"  required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_add_lname">نام خانوادگی</label>
                                    <input type="text" id="sup_add_lname" class="form-control border-primary" placeholder="نام خانوادگی" name="sup_add_lname"  required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_add_user_name">نام کاربری</label>
                                    <input type="text" id="sup_add_user_name" class="form-control border-primary" placeholder="نام کاربری" name="sup_add_user_name"  required >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_add_pass">گذرواژه</label>
                                    <input type="password" id="sup_add_pass" class="form-control border-primary" placeholder="گذرواژه" name="sup_add_pass" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_add_email">ایمیل</label>
                                    <input type="email" id="sup_add_email" class="form-control border-primary" placeholder="ایمیل" name="sup_add_email"  required>
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="sup_add_status">وضعیت</label>
                                    <div class="input-group">
                                        <label class="display-inline-block custom-control custom-radio ml-1">
                                            <input type="radio" id="sup_add_status_enable" name="sup_add_status" class="custom-control-input" value="enable" checked>
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description ml-0">فعال</span>
                                        </label>
                                        <label class="display-inline-block custom-control custom-radio">
                                            <input type="radio" id="sup_add_status_disable" name="sup_add_status" value="disable">
                                            <span class="custom-control-indicator"></span>
                                            <span class="custom-control-description ml-0">غیر فعال</span>
                                        </label>
                    ...
                    <div class="form-actions right">
                        ...
                        <button type="button" class="btn btn-primary" name="sup_add_submit" id="sup_add_submit">
...
<script type="text/javascript">
    ...
    {
        fetch_data_supervisors_tbl();
        function fetch_data_supervisors_tbl()
        {
            var dataTable_employers = $('#supervisors_tbl').DataTable
            (
                {
                    "bPaginate": false,
                    "pageLength":20,
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url"  : "<?php echo admin_url('admin-ajax.php?action=supervisors_data&pdr')?>"
                    },
        ...
        $('#supervisors_tbl tbody').on('click',"#supervisor_edit", function(){
            var e_id = $(this).data("id");
            var e_user_name = $(this).data("username");
            var e_first_name = $(this).data("fname");
            var e_last_name = $(this).data("lname");
            var e_email= $(this).data("email");
            var e_status = $(this).data("status");
            $('#sup_edit_user_name').val(e_user_name);
            $('#sup_edit_fname').val(e_first_name);
            $('#sup_edit_lname').val(e_last_name);
            $('#sup_edit_email').val(e_email);

            if(e_status== "enable")
            {
                $('#sup_edit_status_enable').removeAttr('checked').attr('checked',true);
                $('#sup_edit_status_disable').removeAttr('checked').attr('checked',false);
            }
            else if (e_status== "disable")
            {
                $('#sup_edit_status_enable').removeAttr('checked').attr('checked',false);
                $('#sup_edit_status_disable').removeAttr('checked').attr('checked',true);

            }

            $('#sup_edit_id').val(e_id);

            $('#edit_supervisor_form').modal('toggle');
        });
        $(document).on('click', '#sup_edit_submit', function(){
            var sup_id_edit = $('#sup_edit_id').val();
            var sup_fname_edit = $('#sup_edit_fname').val();
            var sup_lname_edit = $('#sup_edit_lname').val();
            var sup_username_edit = $('#sup_edit_user_name').val();
            var sup_email_edit = $('#sup_edit_email').val();
            var sup_pass_edit = $('#sup_edit_pass').val();
            var sup_status_edit = $("input[name='sup_edit_status']:checked").val();

            if(sup_fname_edit != '' && sup_fname_edit != '' && sup_username_edit != '' && sup_lname_edit != '' && sup_email_edit != '' && sup_pass_edit != '' && sup_status_edit != '')
            {
                $.ajax({
                    url:"<?php echo admin_url('admin-ajax.php?action=supervisor_edit')?>",
                    data:{
                        sup_id_edit:sup_id_edit,
                        sup_fname_edit:sup_fname_edit,
                        sup_lname_edit:sup_lname_edit,
                        sup_username_edit:sup_username_edit,
                        sup_email_edit:sup_email_edit,
                        sup_pass_edit:sup_pass_edit,
                        sup_status_edit:sup_status_edit
                    },
                    success:function(data)
                    {
                        ...
                        if(data[1]=="true")
                        {
                            $('#edit_supervisor_form').modal('hide');
                            $.notify(
                                {
                                    message: data[0]
                                },
                            ...
                            $('#supervisors_tbl').DataTable().destroy();
                            fetch_data_supervisors_tbl();
                        }
                        else
                        {
        ...
        $(document).on('click', '#add_row_supervisor', function(){
            $('#add_supervisor_form').modal('toggle');
        });
        $(document).on('click', '#sup_add_submit', function(){
            var sup_add_fname = $('#sup_add_fname').val();
            var sup_add_lname = $('#sup_add_lname').val();
            var sup_add_user_name = $('#sup_add_user_name').val();
            var sup_add_email = $('#sup_add_email').val();
            var sup_add_pass = $('#sup_add_pass').val();
            var sup_add_status = $("input[name='sup_add_status']:checked").val();

            if( sup_add_fname != '' && sup_add_lname != '' && sup_add_user_name != '' && sup_add_email != '' && sup_add_pass != '' && sup_add_status != '')
            {
                $.ajax({
                    url:"<?php echo admin_url('admin-ajax.php?action=supervisor_add')?>",
                    data:{
                        sup_add_fname:sup_add_fname,
                        sup_add_lname:sup_add_lname,
                        sup_add_user_name:sup_add_user_name,
                        sup_add_email:sup_add_email,
                        sup_add_pass:sup_add_pass,
                        sup_add_status:sup_add_status
                    },
                    success:function(data)
                    {
