    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header"><h4 class="card-title" id="basic-layout-colored-form-control">سند جدید</h4>
                            ...
                            <div class="card-block">
                                <form class="form"  id="pnn_form" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="pnd_title">عــنوان</label>
                                                    <div class="position-relative has-icon-left">
                                                        <input type="text" id="pnd_title" class="form-control round border-primary" placeholder="عـــنوان" name="pnd_title">
                                            ...
                                            <div class="col-md-12" id="pnd_upload_div_1">
                                                <div class="form-group">
                                                    <button type="button" id="pnd_file_1" class="btn btn-primary btn-sm btn-block btn-rounded">
                                            ...
                                            <div class="col-md-12" id="pnd_upload_div_2" style="display: none">
                                                <div class="form-group">
                                                    <label for="pnd_file">ضمیمه</label>
                                                    <div class="position-relative has-icon-left">
                                                        <input type="file" id="pnd_file" class="form-control round border-primary" name="pnd_file">
                                    ...
                                    <div class="form-actions right">
                                        <button type="button" id="pnd_submit" data-class-id="pnd_submit" class="btn btn-block btn-success">
                                            <i class="icon-plus3 fa-lg"></i> افـــزودن
                                        </button>
                                    </div>
                                </form>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">لیست اسناد پروژه</h4>
                            <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="project_doc_tbl" class="table table-responsive-sm table-sm table-hover table-bordered mb-0">
    ...
    <div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function ()
            {
                ...
                fetch_project_doc();
                function fetch_project_doc()
                {
                    var dataTable_projects_doc = $('#project_doc_tbl').DataTable
                    (
                        {
                            ...
                            "serverSide": true,
                            "ajax": {
                                "url"  : "<?php echo admin_url('admin-ajax.php?action=project_doc_data&p_id=' . $p_id)?>"
                            },
                ...
                $(document).on('click', '.ff_fileupload_actions button.ff_fileupload_remove_file', function(){
                    $("#pnd_upload_div_2").hide();
                    $("#pnd_upload_div_1 ").show();
                    added=false;
                });

                $(document).on('click', '#pnd_submit', function()
                {
                    pnd_title=$('#pnd_title').val();
                    if ( pnd_title!='')
                    {
                        if (added)
                        {
                        ...
                        else
                        {
                            $.notify(
                                {
                                    message: 'ابتدا فایل ضمیمه خود را انتخاب نمایید!'
                                },
                                {
                                    type: 'danger',
                                    placement: {
                    ...
                    else
                    {
                        $.notify(
                            {
                                message: 'لطفا عنوان سند را وارد نمایید!'
                            },
                            {
                                type: 'danger',
                                placement: {
                ...
                $(document).on('click', '#pnd_file_1', function()
                {
                    pnd_title=$('#pnd_title').val();
                    if ( pnn_title!='')
                    {
                        $("#pnd_upload_div_1 ").hide();
                        $("#pnd_upload_div_2 ").show();
                        $('#pnd_file').FancyFileUpload({
                            ...
                            uploadcompleted : function(e, data)
                            {
                                ...
                                $("#pnd_upload_div_1 ").show();
                                $("#pnd_title ").val("");
                                $('#project_doc_tbl').DataTable().destroy();
                                fetch_project_doc();

                                $.notify(
                                    {
                                        message: 'سند مد نظر با موفقیت اپلود گردید!'
                                    },
                                    {
                                        type: 'success',
                                        placement: {
                    ...
                    else
                    {
                        $.notify(
                            {
                                message: 'ابتدا عنوان سند را وارد نمایید!'
                            },
                            {
                                type: 'danger',
                                placement: {
                ...
                $(document).on('click', '#se_pd_delete', function(){
                    var id = $(this).data("id");
                    if(confirm("مطمئن هستید?"))
                    {
                        $.ajax({
                            url:"<?php echo admin_url('admin-ajax.php?action=pdd')?>",
                            data:{
                                id:id,
                            },
