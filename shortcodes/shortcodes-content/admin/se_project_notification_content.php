    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header"><h4 class="card-title" id="basic-layout-colored-form-control"><i class="ficon icon-bell4"></i>  اعــلان جــدید</h4>
                                ...
                                <form class="form"  id="pnn_form" enctype="multipart/form-data">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="pnn_text">مـــتن</label>
                                                    <div class="position-relative has-icon-left">
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">اعـــلان های ارسال شده</h4>
                            <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="project_notification" class="table table-responsive-sm table-sm table-hover table-bordered mb-0">
...
<div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function ()
        {
            ...
            function fetch_project_notification()
            {
                var dataTable_man_power = $('#project_notification').DataTable
                (
                    {
                        ...
                        "serverSide": true,
                        "ajax": {
                            "url"  : "<?php echo admin_url('admin-ajax.php?action=project_notification_data&p_id=' . $p_id)?>"
                        },
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            success:function(msg)
                            {
                                ...
                                $("#pnn_title ").val("");
                                $("#pnn_text ").val("");
                                $('#project_notification').DataTable().destroy();
                                fetch_project_notification();
                                $.notify(
                                    {
                                        message: msg
            ...
            $(document).on('click', '#pnn_file_1', function()
            {
                ...
                if (pnn_text != '' && pnn_title!='')
                {
                    ...
                    $('#pnn_file').FancyFileUpload({
                        ...
                        uploadcompleted : function(e, data)
                        {
                            ...
                            $.notify(
                                {
                                    message: 'اعـــلان مدنظر با موفقیت ارسال گــردید!'
                                },
                                {
                                    type: 'success',
                                    placement: {
                ...
                else
                {
                    $.notify(
                        {
                            message: 'ابتدا عنوان و متن اعلان را وارد نمایید!'
                        },
                        {
                            type: 'danger',
                            placement: {
            ...
            $(document).on('click', '#se_pn_delete', function(){
                ...
                {
                    $.ajax({
                        url:"<?php echo admin_url('admin-ajax.php?action=pnd')?>",
                        data:{
                            id:id,
                        },
