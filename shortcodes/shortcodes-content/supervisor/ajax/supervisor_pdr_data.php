...
add_action("wp_ajax_sup_pdaily_report_man_power_data","sup_pdaily_report_man_power_data_server_side_callback");
add_action("wp_ajax_sup_pdr_mp_insert","sup_pdr_mp_insert_server_side_callback");
add_action("wp_ajax_sup_pdr_mp_delete","sup_pdr_mp_delete_server_side_callback");

function sup_pdaily_report_man_power_data_server_side_callback()
{
...
function sup_pdr_mp_insert_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
    ...
    if (isset($request['pdr_id'],$request['pdr_mp_personnel'],$request['pdr_mp_entrance_time'],$request['pdr_mp_exit_time']))
    {
        ...
        else
        {
            ...
            $wpdb->update( $table, array(  'status' => 'pending' ),array('id' => $pdr_id));
        }
        wp_die();
    }
}
...
function sup_pdr_mp_delete_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
...
add_action("wp_ajax_sup_pdaily_report_materials_data","sup_pdaily_report_materials_data_server_side_callback");
add_action("wp_ajax_sup_pdr_materials_insert","sup_pdr_materials_insert_server_side_callback");
add_action("wp_ajax_sup_pdr_materials_delete","sup_pdr_materials_delete_server_side_callback");


function sup_pdaily_report_materials_data_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
    $pdr_id=$request['pdr_id'];
...
function sup_pdr_materials_insert_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
...
function sup_pdr_materials_delete_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
...
add_action("wp_ajax_sup_pdaily_report_machinery_data","sup_pdaily_report_machinery_data_server_side_callback");
add_action("wp_ajax_sup_pdr_machinery_insert","sup_pdr_machinery_insert_server_side_callback");
add_action("wp_ajax_sup_pdr_machinery_delete","sup_pdr_machinery_delete_server_side_callback");


function sup_pdaily_report_machinery_data_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
    $pdr_id=$request['pdr_id'];
...
function sup_pdr_machinery_insert_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
...
function sup_pdr_machinery_delete_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
...
add_action("wp_ajax_sup_pdaily_report_peyments_data","sup_pdaily_report_peyments_data_server_side_callback");
add_action("wp_ajax_sup_pdr_peyments_insert","sup_pdr_peyments_insert_server_side_callback");
add_action("wp_ajax_sup_pdr_peyments_delete","sup_pdr_peyments_delete_server_side_callback");


function sup_pdaily_report_peyments_data_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
    $pdr_id=$request['pdr_id'];
...
function sup_pdr_peyments_insert_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
...
function sup_pdr_peyments_delete_server_side_callback()
{
    header("Content-Type: application/json");
    $request= $_GET;
