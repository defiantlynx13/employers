        ...
        <div class="content-body">
            ...
            <p>
                <span class="float-xs-right">
                    ...
                    <a type="button" class="btn purple-gradient btn-rounded white mr-1 mb-1 waves-effect waves-light" href="<?php echo home_url('se_supervisor_pdrs_list/?p_id='.$p_id)?>">
...
/////////////////////////////////////////////////////////////// start man power///////////////////////////////
            ...
            (
                {
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url"  : "<?php echo admin_url('admin-ajax.php?action=sup_pdaily_report_man_power_data&pdr_id=' . $pdr_id)?>"
                    },
        ...
        $(document).on('click', '#se_pdr_mp_insert', function(){
            ...
            {
                $.ajax({
                    url:"<?php echo admin_url('admin-ajax.php?action=sup_pdr_mp_insert&pdr_id=' . $pdr_id)?>",
                    data:{
        ...
        $(document).on('click', '#se_pdr_mp_delete', function(){
            ...
            {
                $.ajax({
                    url:"<?php echo admin_url('admin-ajax.php?action=sup_pdr_mp_delete')?>",
                    data:{
                        id:id,
                    },
                    success:function(data){
...
/////////////////////////////////////////////////////////////// start materials//////////////////////////////
            ...
            (
                {
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url"  : "<?php echo admin_url('admin-ajax.php?action=sup_pdaily_report_materials_data&pdr_id=' . $pdr_id)?>"
                    },
                    "fnDrawCallback" : function() {
                        traverse(document.body);
                    }
        ...
        $(document).on('click', '#se_pdr_materials_insert', function(){
            ...
            {
                $.ajax({
                    url:"<?php echo admin_url('admin-ajax.php?action=sup_pdr_materials_insert&pdr_id=' . $pdr_id)?>",
                    data:{
        ...
        $(document).on('click', '#se_pdr_materials_delete', function(){
            ...
            if(confirm("مطمئن هستید?")) {
                $.ajax({
                    url: "<?php echo admin_url('admin-ajax.php?action=sup_pdr_materials_delete')?>",
                    data: {
                        id: id,
                    },
                    success: function (data) {
            ...
            (
                {
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url"  : "<?php echo admin_url('admin-ajax.php?action=sup_pdaily_report_machinery_data&pdr_id=' . $pdr_id)?>"
                    },
                    "fnDrawCallback" : function() {
                        traverse(document.body);
                    }
        ...
        $(document).on('click', '#se_pdr_machinery_insert', function(){
            ...
            {
                $.ajax({
                    url:"<?php echo admin_url('admin-ajax.php?action=sup_pdr_machinery_insert&pdr_id=' . $pdr_id)?>",
                    data:{
        ...
        $(document).on('click', '#se_pdr_machinery_delete', function(){
            ...
            if(confirm("مطمئن هستید?")) {
                $.ajax({
                    url: "<?php echo admin_url('admin-ajax.php?action=sup_pdr_machinery_delete')?>",
                    data: {
                        id: id,
                    },
                    success: function (data) {
            ...
            (
                {
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url"  : "<?php echo admin_url('admin-ajax.php?action=sup_pdaily_report_peyments_data&pdr_id=' . $pdr_id)?>"
                    },
                    "fnDrawCallback" : function() {
                        traverse(document.body);
                    }
        ...
        $(document).on('click', '#se_pdr_peyments_insert', function(){
            ...
            {
                $.ajax({
                    url:"<?php echo admin_url('admin-ajax.php?action=sup_pdr_peyments_insert&pdr_id=' . $pdr_id)?>",
                    data:{
        ...
        $(document).on('click', '#se_pdr_peyments_delete', function(){
            ...
            if(confirm("مطمئن هستید?")) {
                $.ajax({
                    url: "<?php echo admin_url('admin-ajax.php?action=sup_pdr_peyments_delete')?>",
                    data: {
                        id: id,
                    },
                    success: function (data) {
