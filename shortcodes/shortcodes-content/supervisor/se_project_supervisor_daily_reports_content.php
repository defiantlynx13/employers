    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            ...
            if (isset($_GET['p_id']))
            {
                ...
                $s_id=get_current_user_id();
                $query = "SELECT * FROM {$table} WHERE id={$p_id} and sid={$s_id}";
    ...
    $(document).ready(function () {
            ...
            (
                {
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url"  : "<?php echo admin_url('admin-ajax.php?action=supervisor_pdaily_reports_data&p_id=' . $p_id)?>",
                        "data" : {searchDate}
                    },
        ...
        $(document).on('click', '#add_row', function(){
            ...
            html += '<td  >' +
                ...
                '</td>';
            html += '<td><span class="tag tag-default tag-info">منتظر بررسی</span></td>';
        ...
        $(document).on('click', '#se_pdr_insert', function(){
            ...
            if(pdr_date != '' && pdr_min_temp != '' && pdr_max_temp != '')
            {
                $.ajax({
                    url:"<?php echo admin_url('admin-ajax.php?action=supervisor_pdr_insert&p_id=' . $p_id)?>",
                    data:{
                        pdr_date:pdr_date,
        ...
        $(document).on('click', '#se_pdr_delete', function(){
            ...
            {
                $.ajax({
                    url:"<?php echo admin_url('admin-ajax.php?action=supervisor_pdr_delete')?>",
                    data:{
                        id:id,
                    },
                    success:function(data){
        ...
        $(document).on('click', '#se_pdr_complete', function(){
            var id = $(this).data("id");
            var home_url="<?php echo home_url();?>/se_supervisor_pdr_list/?p_id=<?php echo $p_id?>&pdr_id=";
        ...
        $('body').on('click',"#se_pdr_edit_submit", function(){
            ...
            if(pdr_date_edit != '' && pdr_min_temp_edit != '' && pdr_max_temp_edit != '')
            {
                $.ajax({
                    url:"<?php echo admin_url('admin-ajax.php?action=supervisor_pdr_update&p_id=' . $p_id)?>",
                    data:{
