...
add_shortcode('SE_employee_pdr_list' , 'SE_employee_pdr_list_function');


function SE_employee_pdr_list_function()
{
    ...
    {
        require_once( plugin_dir_path(__FILE__) . 'shortcodes-content/employers/se_project_employee_daily_report_content.php' );
    }
