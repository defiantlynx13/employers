...
add_shortcode('SE_project_emp_message' , 'SE_project_emp_message_function');


function SE_project_emp_message_function()
{
    ...
    {
        require_once( plugin_dir_path(__FILE__) . 'shortcodes-content/employers/se_project_emp_message_content.php' );
    }
