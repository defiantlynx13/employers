...
add_shortcode('SE_employee_pdrs_list' , 'SE_employee_pdrs_list_function');


function SE_employee_pdrs_list_function()
{
    ...
    {
        require_once( plugin_dir_path(__FILE__) . 'shortcodes-content/employers/se_project_employee_daily_reports_content.php' );
    }
