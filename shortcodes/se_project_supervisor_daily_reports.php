...
add_shortcode('SE_supervisor_pdrs_list' , 'SE_supervisor_pdrs_list_function');


function SE_supervisor_pdrs_list_function()
{
    ...
    {
        require_once( plugin_dir_path(__FILE__) . 'shortcodes-content/supervisor/se_project_supervisor_daily_reports_content.php' );
    }
