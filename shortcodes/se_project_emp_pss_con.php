...
add_shortcode('SE_project_emp_pss_con' , 'SE_project_emp_pss_con_function');


function SE_project_emp_pss_con_function()
{
    ...
    {
        require_once( plugin_dir_path(__FILE__) . 'shortcodes-content/employers/se_project_emp_pss_con_content.php' );
    }
